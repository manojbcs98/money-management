...
class SharedPrefs {
  ...
  void clearAllExceptList(List<String> keysToKeep) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String> keysToRemove = [];

    // Get all keys in shared preferences
    Set<String> keys = prefs.getKeys();

    // Iterate through all keys and add the ones to remove
    ...
    // Remove the keys from shared preferences
