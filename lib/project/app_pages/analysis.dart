...
import 'package:money_management/project/classes/chart_pie.dart';
import 'package:money_management/project/classes/constants.dart';
import 'package:money_management/project/classes/dropdown_box.dart';
...
class DateDisplay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String since = 'since';
    TextStyle style = TextStyle(fontSize: 22.sp, fontWeight: FontWeight.bold);
