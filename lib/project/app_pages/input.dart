...
import 'package:money_management/project/classes/keyboard.dart';
...
void saveInputFunc(BuildContext context, bool saveFunction) {
  ...
  if (_amountController.text.isEmpty) {
    customToast(context, 'Enter more than 0');
  }
  if (saveFunction) {
    DB.insert(model);
    _amountController.clear();
...
onDeletion(BuildContext context) async {
