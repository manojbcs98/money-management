import 'package:money_management/project/app_pages/parent_category.dart';
import 'package:money_management/project/classes/app_bar.dart';
import 'package:money_management/project/classes/category_item.dart';
import 'package:money_management/project/classes/constants.dart';
import 'package:money_management/project/classes/saveOrSaveAndDeleteButtons.dart';
...
import 'package:money_management/project/provider.dart';
            ...
            child: ChangeNotifierProvider<ChangeCategory>(
              ...
              child: ListView(
                children: [
                  CategoryName(
                      this.type,
                      this.categoryName == null ? null : this.categoryName,
                      this.categoryIcon),
    ...
    return Selector<ChangeCategory, CategoryItem?>(
        ...
        builder: (context, selectedParentItem, child) {
          selectedParentItem ??= widget.parentItem ??
              categoryItem(Icons.category_outlined, 'Parent category');
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: selectedParentItem.text == "Parent category"
                            ? TextStyle(
                                fontSize: 22.sp,
                                color: grey,
                                fontStyle: FontStyle.italic,
      ...
      if (widget.formKey.currentState!.validate()) {
        ...
        if (widget.contextInEdit != null) {
          ...
          if ((widget.categoryName == null) && (widget.parentItem == null)) {
            ...
            print('add expense');
            if (finalParent!.text == "Parent category") {
              print('add parent');
